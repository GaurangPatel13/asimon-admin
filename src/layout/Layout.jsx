      ...
      subRoutes: [
        {
          ...
          path: `${Routers.userTransactionHistory}`,
          icon: <AiOutlineHistory size={16} />,
        },
        {
          label: "User Income History",
          path: `${Routers.userIncomeHistory}`,
          icon: <AiOutlineHistory size={16} />,
        },
        // {
        //   label: "Wallet Holder ",
  ...
  return (
    <>
      ...
      <div
        ...
        className="flex justify-end md:p-2 gap-4 w-full h-screen  bg-bg-color1"
      >
        <div
          ...
          <div className="py-2 space-y-1">
            ...
            {actionButtons.map(({ label, icon, bgColor, func }, index) => (
              <div key={index} className="p-2">
                ...
                >
                  <div
                    className={`p-2 ${bgColor} text-white rounded-lg text-base`}
                  >
                    {icon}
                  </div>
                  {label}
